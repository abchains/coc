...
int64 nChainStartTime = 1527063498;
...
const string strMessageMagic = "Culture-orientedTravelChain Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Culture-orientedTravelChain
    bool fStrictPayToScriptHash = true; // Always active in Culture-orientedTravelChain
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Culture-orientedTravelChain", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum vector Culture-orientedTravelChain empty mapBlockIndex Culture-orientedTravelChain Culture-orientedTravelChain";
        CTransaction txNew;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0x4ee9c91d2083da8039ea92815549feae21aa6456ffdee29233d1f98a7618fbe7"));
