TEMPLATE = app
TARGET = Culture-orientedTravelChain-qt
VERSION = 0.8.5
...
QT += testlib
TARGET = Culture-orientedTravelChain-qt_test
...
macx:ICON = src/qt/res/icons/Culture-orientedTravelChain.icns
macx:TARGET = "Culture-orientedTravelChain-Qt"
